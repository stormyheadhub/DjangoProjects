...
def home(request):
    ...
    if request.method == 'POST':
        pk = request.POST.get('account') # If the form is submitted, retrieve which account the user wants to view
...
def balance(request, pk):
    ...
    current_total = account.initial_deposit # Create account total variable, starting with intitial deposit value
    table_contents = {} # Create a dictionary into which transactions information will be placed
